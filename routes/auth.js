...
let { SECRET_KEY } = require('../middleware/auth');
...
router.post('/login', async function (req, res, next) {
    try {
        ...
        // Kiểm tra tài khoản có bị vô hiệu hóa không (sau khi xác minh mật khẩu)
        if (!user.status) {
...
router.post('/change-password', require('../middleware/auth').verifyToken, async function (req, res, next) {
    try {
